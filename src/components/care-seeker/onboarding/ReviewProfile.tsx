  ...
  const handleSubmit = async () => {
    try {
      ...
      toast({
        ...
        description: "Your profile has been saved successfully. Welcome to em.path!",
      });
  ...
  return (
    <div>
      <CardHeader className="px-0">
        ...
        <CardDescription>
          Please review the information you've provided before proceeding to your dashboard
        </CardDescription>
      </CardHeader>
